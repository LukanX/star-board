...
export default function EnemyPublicRecord({ campaignId, enemy, isGM, actions }: { campaignId: string; enemy: ApiEnemy; isGM: boolean; actions?: ReactNode }) {
  ...
  const playerBrief = <MarkdownPreview data-enemy-player-notes="true"><MarkdownPreviewToolbar><BookOpen size={14} /> PLAYER BRIEF <span>PLAYER VISIBLE</span></MarkdownPreviewToolbar><p>{enemy.player_description || "No player brief recorded yet."}</p></MarkdownPreview>;
