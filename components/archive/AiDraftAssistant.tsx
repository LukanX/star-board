...
function AiDraftAssistantContent({ campaignId, endpoint, entityLabel, mode, fields, contextFields, requestFields, currentDraft, showModelPicker = true, toolLabel = "GM TOOL", onApply }: AiDraftAssistantProps) {
