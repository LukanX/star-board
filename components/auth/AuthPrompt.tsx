  ...
  return (
    <main className={authShellClassName}>
      ...
      <section className={`${authPanelClassName} ${authPromptPanelClassName}`}>
        ...
        <div className={authHeadingClassName}><p className={eyebrowBrightClassName}><span className={liveDotBrightClassName} /> CAMPAIGN CONSOLE</p><h1>Open your campaign console.</h1><p>Sign in to continue to an existing campaign, or create an account to start a new one.</p></div>
