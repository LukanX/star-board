...
export async function POST(request: Request) {
  ...
  try {
    ...
    try {
      ...
      return campaignCredentialErrorResponse(error, "Place assistance is temporarily unavailable.");
    }
    ...
    try {
      providerResult = await generateJson(campaignCredential.apiKey, prompt, placeDraftSchema, selectedModel.id);
