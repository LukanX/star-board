...
3. Apply `supabase/migrations/0001_initial.sql` through `0024_campaign_ai_customization.sql` in order through the Supabase SQL editor or the linked Supabase CLI.
